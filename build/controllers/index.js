...
}, _defineProperty(_renderHome$renderLog, "renderHome", _home.renderHome), _defineProperty(_renderHome$renderLog, "createPedido", _pedidos.createPedido), _defineProperty(_renderHome$renderLog, "renderEmpleo", _empleo.renderEmpleo), _defineProperty(_renderHome$renderLog, "renderPedidos", _pedidos.renderPedidos), _defineProperty(_renderHome$renderLog, "renderPedido", _pedidos.renderPedido), _defineProperty(_renderHome$renderLog, "updateStatus", _pedidos.updateStatus), _defineProperty(_renderHome$renderLog, "renderProduct", _pedidos.renderProduct), _defineProperty(_renderHome$renderLog, "createProduct", _pedidos.createProduct), _defineProperty(_renderHome$renderLog, "updateProduct", _pedidos.updateProduct), _defineProperty(_renderHome$renderLog, "deleteProduct", _pedidos.deleteProduct), _defineProperty(_renderHome$renderLog, "renderCategorie", _pedidos.renderCategorie), _renderHome$renderLog);
